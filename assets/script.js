$(document).ready(function () {
    ...
    // gets information of current conditions of the searced city
    ...
    // function to get information from last city to render on the page again
    ...
    // adds the sity to the page in recent searches
